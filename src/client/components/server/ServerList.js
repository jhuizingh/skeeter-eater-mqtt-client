...
export default class ServerList extends React.Component {
  static propTypes = {
    ...
    selectedServer: PropTypes.shape({ id: PropTypes.string })
  };
  ...
  componentDidMount() {
    ...
    WebSocketClient.addListener(collectionName, (action, data) => {
      ...
      this.setState(CollectionHelper.GetSetStateDelegate(action, 'servers', data));
    });
  }
          ...
          <Container>
            <Row className="mb-3">
              <Col xs="auto" className="align-self-center">
                <Button title="Add Server" variant="primary" onClick={this.handleAddServer}>
                  {'+'}
                </Button>
              </Col>
              <Col>
